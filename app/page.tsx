  ...
  return (
    <div className="w-full max-w-7xl mx-auto space-y-4 md:space-y-8 animate-in fade-in zoom-in duration-500">
      <div className="flex flex-col mb-4 md:mb-8 mt-2">
        <h1 className="text-xl md:text-2xl font-bold tracking-tight bg-clip-text text-transparent bg-gradient-to-r from-blue-600 to-cyan-500 dark:from-blue-400 dark:to-cyan-300 mb-1 md:mb-2">
          Welcome back, {userName.split(' ')[0]}.
        </h1>
        <h2 className="text-2xl md:text-3xl font-extrabold bg-clip-text text-transparent bg-gradient-to-r from-slate-900 to-slate-500 dark:from-white dark:to-slate-400">
          Dashboard Overview
        </h2>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-4 md:gap-8">
        ...
        <div className="lg:col-span-1">
          ...
          <div className="bg-white/40 dark:bg-black/30 backdrop-blur-2xl border border-white/60 dark:border-white/10 shadow-[0_8px_30px_rgb(0,0,0,0.04)] rounded-[24px] md:rounded-[32px] p-4 md:p-6 h-full flex flex-col items-center">
            <h3 className="text-lg md:text-xl font-bold bg-clip-text text-transparent bg-gradient-to-r from-slate-900 to-slate-700 dark:from-white dark:to-slate-300 w-full mb-4 md:mb-6">
              Recent Activity
            </h3>
            <div className="w-full flex-1 flex flex-col gap-3 md:gap-4 overflow-y-auto">
